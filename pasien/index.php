                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='edit.php?id=" . $row['id_pasien'] . "><button class='btn btn-warning'>Edit</button></a>";
                                        echo "<a href='delete.php?id=" . $row['id_pasien'] . ">' onclick='return confirm(\"Yakin Hapus Data?\")'><button class='btn btn-danger'>Delete</button></a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
